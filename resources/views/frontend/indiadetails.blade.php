          ...
          <div class="col-lg-12 col-md-12">
            <div class="breadcrumb-text">
              <ul>
                ...
                <li>{{ $india_slug->title }}</li>
              </ul>
              <h2>{{ $india_slug->title }}</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="projects-detail-img">
              <img src="{{ asset('public/projects/image/' . $india_slug->image) }}" class="img-responsive">
            </div>
          </div>
          <div class="col-md-7">
            <div class="projects-detail-text">
              <div class="horizontal-line"></div>
              <p>{!! $india_slug->description !!}.</p>
            </div>
            <div class="project-list-list">
              <div class="project-list">
                <h5>Client</h5>
                <p>{{ $india_slug->client }}</p>
              </div>
              <div class="project-list">
                <h5>Architect/ Consultant</h5>
                <p>{{ $india_slug->consultant }}</p>
              </div>
              <div class="project-list">
                <h5>Facade Area</h5>
                <p>{{ $india_slug->area }}</p>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="owl-carousel owl-theme featured">
              @foreach($indiaDetails_fetch as $details)
              <div class="item">
