...
<div class="content">
    <div class="row">
        <div class="col-lg-30">
            <div class="card">
            <form method="post" action="{{ route('fabrication_img_update',$data->id) }}"
                        ...
                        <div class="box-content">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3 mt-3 w-100">
                                    <label>Image</label>
                                    <img src="{{ asset('public/fabrication_img/image/'.$data->image) }}" style="height:50px; width:50px;" alt="Current Image">
