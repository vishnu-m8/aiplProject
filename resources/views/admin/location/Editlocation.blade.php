                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3 mt-3 w-100">
                                        ...
                                        <textarea class="form-control editor" placeholder="Location Details"
                                            name="location_detail"> {{ $data->location_detail }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 mt-3 w-100">
                                        ...
                                        <input class="form-control" placeholder="Location Url"
                                            name="location_url" value="{{ $data->location_url }}">
                                        <span class="text-danger">
                                            @error('location_url')
                                            {{ $message }}
                                            @enderror
